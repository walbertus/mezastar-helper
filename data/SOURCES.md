# Mezatag Data Sources

Tracks which Bulbapedia Mezastar set pages have been crawled into `mezatags.json`.
...
- https://bulbapedia.bulbagarden.net/wiki/Gorgeous_Star_set_1_(Mezastar)
...
- https://bulbapedia.bulbagarden.net/wiki/Promotional_tags_(Mezastar)
